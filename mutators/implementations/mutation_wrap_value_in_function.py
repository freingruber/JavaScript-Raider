...
def mutation_wrap_value_in_function(content, state):
    # utils.dbg_msg("Mutation operation: Wrap value in function")
    tagging.add_tag(Tag.MUTATION_WRAP_VALUE_IN_FUNCTION1)
    ...
    if len(positions_of_numbers) == 0:
        tagging.add_tag(Tag.MUTATION_WRAP_VALUE_IN_FUNCTION2_DO_NOTHING)
