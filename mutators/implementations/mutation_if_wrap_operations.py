...
def mutation_if_wrap_operations(content, state):
    tagging.add_tag(Tag.MUTATION_IF_WRAP_OPERATIONS1)
    ...
    random_boolean_value = js.get_random_boolean_value(state, start_line)
    code_prefix = "if (%s) {" % random_boolean_value
    code_suffix = "}"
