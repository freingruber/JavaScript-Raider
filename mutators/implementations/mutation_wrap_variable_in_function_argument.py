...
# }
# let x = inlinee(var_1_)
#
# => Simplified to:
# let x = (function _() {return _.arguments[0]})(var_1_)
#
#
#
...
def mutation_wrap_variable_in_function_argument(content, state):
    # utils.dbg_msg("Mutation operation: Wrap variable in function argument")
    tagging.add_tag(Tag.MUTATION_WRAP_VARIABLE_IN_FUNCTION_ARGUMENT1)
    ...
    if len(positions_of_variables) == 0:
        tagging.add_tag(Tag.MUTATION_WRAP_VARIABLE_IN_FUNCTION_ARGUMENT2_DO_NOTHING)
    ...
    new_code = "(function _() {return _.arguments[0]})(%s)" % original_variable
