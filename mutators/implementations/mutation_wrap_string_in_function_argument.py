...
# }
# let x = inlinee("foobar")
#
# => Simplified to:
# (function _() {return _.arguments[0]})("foobar")
...
def mutation_wrap_string_in_function_argument(content, state):
    # utils.dbg_msg("Mutation operation: Wrap string in function argument")
    tagging.add_tag(Tag.MUTATION_WRAP_STRING_IN_FUNCTION_ARGUMENT1)
    ...
    if len(positions_of_strings) == 0:
        tagging.add_tag(Tag.MUTATION_WRAP_STRING_IN_FUNCTION_ARGUMENT2_DO_NOTHING)
    ...
    new_code = "(function _() {return _.arguments[0]})(%s)" % original_string
